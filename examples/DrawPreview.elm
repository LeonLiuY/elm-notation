...
main =
    div []
        ...
        , div [ Html.Attributes.style [ ( "display", "flex" ), ( "flex-wrap", "wrap" ) ] ]
            [ coordinate "slur" <| slur ( 1, 2 ) ( 2.4, 2 ) ( 5, 0 ) []
        ...
        , div [ Html.Attributes.style [ ( "display", "flex" ), ( "flex-wrap", "wrap" ) ] ]
            [ coordinate "note {duration = 0}" <| g [] [ note { duration = 0, stemDirection = Up } [], staff5Line 4 [ translate ( -1, -3.5 ) ] ]
            , coordinate "note {duration = 1}" <| g [] [ note { duration = 1, stemDirection = Up } [], staff5Line 4 [ translate ( -1, -3.5 ) ] ]
            , coordinate "note {duration = 2}" <| g [] [ note { duration = 2, stemDirection = Up } [], staff5Line 4 [ translate ( -1, -3.5 ) ] ]
            , coordinate "note {duration = 3}" <| g [] [ note { duration = 3, stemDirection = Up } [], staff5Line 4 [ translate ( -1, -3.5 ) ] ]
            , coordinate "note {duration = 4}" <| g [] [ note { duration = 4, stemDirection = Up } [], staff5Line 4 [ translate ( -1, -3.5 ) ] ]
            , coordinate "note {duration = 1}" <| g [] [ note { duration = 1, stemDirection = Down } [], staff5Line 4 [ translate ( -1, -0.5 ) ] ]
            , coordinate "note {duration = 2}" <| g [] [ note { duration = 2, stemDirection = Down } [], staff5Line 4 [ translate ( -1, -0.5 ) ] ]
            , coordinate "note {duration = 3}" <| g [] [ note { duration = 3, stemDirection = Down } [], staff5Line 4 [ translate ( -1, -0.5 ) ] ]
            , coordinate "note {duration = 4}" <| g [] [ note { duration = 4, stemDirection = Down } [], staff5Line 4 [ translate ( -1, -0.5 ) ] ]
            ]
        ]
